...
Partial Class _Default
    ...
    Private Sub getmastres()
        ...
        qry = "select logid,advid,vac_id,candid,to_char(rounddat,'dd-Mon-yyyy') RoundDt,(select name from tt.employees where empno=CONDUCTEDBY) RoundBy,(select candname from ams.bdc_lead_master a  where a.candid=t1.candid) Candidate,candfdbck as Remarks from ams.bdc_cand_rnd_log t1 where candid='" & Request.QueryString("candid") & "'"
        'qry = "select logid,advid,vac_id,candid,to_char(rounddat,'dd-Mon-yyyy') RoundDt,(select name from tt.employees where empno=CONDUCTEDBY) RoundBy,(select candname from ams.bdc_lead_master a  where a.candid=t1.candid) Candidate,(select vacname from ams.adv_vacancy where vacid=vac_id) Vacancy from ams.bdc_cand_rnd_log t1 where candid='" & Request.QueryString("candid") & "'"
    ...
    Protected Sub RadGrid1_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        If e.CommandName = "pround" Then
            ...
            Ifrmfollowup1.Attributes.Add("src", "jobsecure_list.aspx?aid=" & e.CommandArgument.ToString())
        ...
        ElseIf e.CommandName = "nround" Then
            ...
            Ifrmfollowup1.Attributes.Add("src", "bdc_inv_Resultpop.aspx?aid=" & e.CommandArgument.ToString())
