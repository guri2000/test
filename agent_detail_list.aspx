<%@ Page Title="" Language="VB"  MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="agent_detail_list.aspx.vb" Inherits="Default2" %>
          ...
          <div class="widget-content nopadding">
            ...
            AllowPaging="True" CellSpacing="0" GridLines="none"  
             AllowSorting="True" ShowHeader="true"     AllowFilteringByColumn="True"  runat="server" >
              ...
              <MasterTableView DataKeyNames="agntid" NoMasterRecordsText="No records to display" CommandItemDisplay="Top" >
               <NoRecordsTemplate>
      <div>
        No records to display</div>
               ...
               <ColumnGroups>
                        ...
                        <Columns>
                          <telerik:GridTemplateColumn UniqueName="" HeaderText="" 
                            ItemStyle-Wrap="false" AllowFiltering="false" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                            <HeaderTemplate>
                            ...
                            <ItemTemplate>
                             <%--<asp:ImageButton ID="btnget"  runat="server"  border="0" />&nbsp;&nbsp;--%>
                              <asp:ImageButton ID="btnedit" ImageUrl="Images/edit-ico-small.png" CommandName="editform" runat="server" Width="16px"  border="0" /> &nbsp;&nbsp;
                               <asp:ImageButton ID="btnrst" ImageUrl="Images/rest-pwd.png" CommandName="Reset" runat="server" ToolTip="Reset Password" CommandArgument='<%# Eval("agntid")%>' Width="16px"  border="0" /> &nbsp;&nbsp;
							   <img src="Images/view_pass.png" id="tipimg" runat="server" style="Width:16px" Title='<%# Eval("pwd")%>'  />
                            </ItemTemplate>
            ...
            <%-- <CommandItemSettings AddNewRecordText="Add new record" AddNewRecordImageUrl="Images/AddRecord.png"
                ...
                <div class="modal-header">
                  ...
                  <h3 style="font-size:14px;font-style:normal;font-weight:600;font-family:Arial;">Add New Agent Record</h3>
                </div>
                <div class="modal-body">
                <iframe runat="server" id="addnewfrm" scrolling="no"  frameborder="0" width="100%" height="400px" src="agent_det.aspx"></iframe>
