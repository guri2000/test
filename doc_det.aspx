    ...
    <div class="span4">
      <div class="widget-box" style="margin-top:0px">
        ...
        <div class="widget-content">
            ...
            <div class="control-group">
              <label for="normal" class="control-label">Document Scope:<span style="color:Red;">*</span></label>
              <div class="controls">
                <asp:DropDownList ID="ddlScope"   AppendDataBoundItems="true" class="span11" runat="server">
               <asp:ListItem Value="" >Choose Scope</asp:ListItem>
                <asp:ListItem Value="1" >Job offer (Check List)</asp:ListItem>
                 <asp:ListItem Value="2" >Document Library</asp:ListItem>
                  </asp:DropDownList>
