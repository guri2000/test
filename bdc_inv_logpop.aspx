<%@ Page Title="" Language="VB" MasterPageFile="~/popup.master" AutoEventWireup="false" CodeFile="bdc_inv_logpop.aspx.vb" Inherits="_Default" %>
...
<span id="error" style="color: Red; display: none"> ~ ` ! ^ & ( ) _ { } [ ] | \ : ; " < > ? Special Characters not allowed</span>
     ...
     <div class="widget-box" style="margin-top: 10px;">
        <div class="widget-title" style="margin-top: 0px;"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Previous Interview Round</h5>   
          ...
          <div class="control-group">
            ...
            AllowPaging="false" CellSpacing="0" GridLines="none"    
             AllowSorting="true" ShowHeader="true" PageSize="12" AllowFilteringByColumn="true"  runat="server" >
              ...
              <MasterTableView CommandItemDisplay="Top"   DataKeyNames="advid" NoMasterRecordsText="No records to display" >
               <NoRecordsTemplate>
                  <div>
...
<asp:LinkButton ID="LinkButton1" Visible="False" runat="server" CommandName="EmployerFilter"><img src="images/refresh16x16.png" style="display:none;" border="0" alt="" /></asp:LinkButton>
              ...
              <%-- <ColumnGroups>
                        ...
                        <Columns>                      
                             <telerik:GridTemplateColumn UniqueName="" HeaderText=""  Visible ="false"
