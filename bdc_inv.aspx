...
<script type="text/javascript">
    ...
    $(document).on("click", '#<%= RadTabStrip2.ClientID %>', function () {
        var tabStrip = $find("<%= RadTabStrip2.ClientID %>");
        var tabStrip2 = $find("<%= RadTabStrip1.ClientID %>");       
        //tabStrip2.set_visible(true);    
        if (tabStrip.get_selectedTab().get_value() == "1") {                  
            $('#tabCand').show();
        }
        else
            $('#tabCand').hide();
...
//    $(document).on("click", ".openIDialog", function (e) {
//        var myImageId = $(this).data('id');
//        e.preventDefault();
//        //alert(myImageId);
//        if (myImageId == "ChangePwd.aspx")
//            $("#mdltitle").html("Change Password");
//        else
//            $("#mdltitle").html("Complaint Cell");

//        $("#Iframe1").attr("src", myImageId);
...
<telerik:RadWindowManager ID="RadWindowManager1" runat="server">
    ...
    <div class="row-fluid" style="margin-top: 7px;">
      ...
      <div class="span12">
           ...
           <telerik:RadTabStrip ID="RadTabStrip2"  RenderMode="Lightweight"   runat="server"  MultiPageID="RadMultiPage2"
...
<telerik:RadMultiPage ID="RadMultiPage2"  runat="server" SelectedIndex="0">
        ...
        <%--   
              <a  class="btn_gen openIDialog" title="Add New Vacancy"  data-id="bdc_inv_Vacpop.aspx"  href="#modeCanddetail" data-toggle="modal"  >New Vac2.</a>
       --%>       
                 <asp:LinkButton  id="ADDVAC"   class="btn_gen" title="Add New Vacancy"   runat="server"   >New Vac.</asp:LinkButton>
...
<asp:LinkButton ID="LinkButton1" Visible="False" runat="server" CommandName="EmployerFilter"><img src="images/refresh16x16.png" style="display:none;" border="0" alt="" /></asp:LinkButton>
           ...
           <%--        <div class="modal hide" id="addnewCand">
              ...
              <div class="modal hide" id="modeCanddetail">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">×</button>
                  <h3 style="font-size:14px;font-style:normal;font-weight:600;" id="mdltitle">View/Add Resume</h3>
                </div>
                <div class="modal-body">
                    <iframe  id="Iframe1"  frameborder="0" width="100%" height="420px" src=""></iframe>
                </div>
              </div>
