...
Partial Class _Default
    ...
    Private Sub getrcdforedit()
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                ddlScope.Items.FindByValue(Convert.ToString(dt.Rows(0)("doc_SCOPE"))).Selected = True
    ...
    Public Function InsertCommand() As Boolean
        Try
            ...
            End If
            If ddlScope.SelectedValue <> "" Then
                str.Append("DOC_SCOPE,")
            End If
            ...
            If ddlScope.SelectedValue <> "" Then
                str.Append("'" & ddlScope.SelectedValue & "',")
            End If
