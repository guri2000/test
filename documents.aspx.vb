...
Partial Class Default2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            If Not Request.QueryString("chk") Is Nothing Then
                If Request.QueryString("chk") = "BDC" Then
                    Bind_ViewGrid_all("A")
                End If
            End If
    ...
    Private Sub getmaster1()
        Try
            ...
            qry = "select  DOC_ID AS docid, DOC_DESCRIPTION as docname from AMS.AMS_DOCMASTER where DOC_STATUS='Y' AND DOC_SCOPE=2 "
    ...
    Protected Sub rad_document_viewer_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles RadGrid1.SelectedIndexChanged
        ...
        If dataItem IsNot Nothing Then
            ...
            Panel2.Visible = True
            'Hide upload from BDC
            If Not Request.QueryString("chk") Is Nothing Then
                If Request.QueryString("chk") = "BDC" Then
                    Panel2.Visible = False
                    FileUpload1.Enabled = False
                    Button1.Enabled = False
                    Label6.Text = "Access Denied"
                End If
            End If
